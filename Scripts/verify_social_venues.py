...
# Preserve the social milestone and exact roadmap math while following the
# current SWIR Visual Report v3 contract: the SVG mini is the only progress
# meter on the maintained roadmap; numeric badges/table remain authoritative.
for token in (
...
print(f"Social venues sanity OK: {checked}/{total} ({percent:.1f}%), SVG-only progress verified")
