...
# Source emits the path through a printf placeholder (`path=%s`) with
# VehiclePath=TEXT("NATIVE_CHAOS").  Verify that semantic contract rather than
# requiring the final rendered log token to appear literally in C++ source.
checks = {
