...
print(f'Packaged gameplay smoke verification passed ({len(checks)} checks) under current last-proven 0.1.14 candidate label; runtime={minimum_alive}s, gameplay={minimum_gameplay}s, timeout={launch_timeout}s.')
