...
print(f"[OK] GTT 0.1.2 Rattleback ROAD courier is wired through fleet prep, traffic/crash risk, police, economy and save ({len(checks)} checks); roadmap {done}/{total} = {percent:.1f}%.")
