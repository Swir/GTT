...
playtest=(root/'Docs/PLAYTEST_0.0.90.md').read_text(encoding='utf-8')
changelog=(root/'CHANGELOG.d/0.0.90.md').read_text(encoding='utf-8')
checks={
 ...
 '25 step completion': 'steps=25' in cpp and 'steps=25' in eval_ps,
 'schema v7': 'gtt.demo-scenario.v7' in eval_ps and 'physical_crossing_passed' in eval_ps and 'wheel_risk_after' in eval_ps,
 'workflow 0.0.90': "default: '0.0.90'" in workflow and 'physical native roadblock crossing evidence' in workflow,
 'docs': '0.0.90' in playtest and '0.0.90' in changelog,
}
