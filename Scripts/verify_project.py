...
EXPECTED_SOURCE_TOKENS = {
    ...
    "Source/GTT/Private/Vehicles/GTTVehicleBase.cpp": [
        "AddForce(", "AddTorqueInRadians(", "CurrentFuelLiters", "MarkOwnedByPlayer", "RestorePersistentState", "bTheftReported = false"
    ],
    "Source/GTT/Private/Vehicles/GTTTractorPawn.cpp": [
        "Rusty Fieldmaster 60", "RustyFieldmaster60", "FuelCapacityLiters = 55.0f", "StartingFuelLiters = 18.0f"
    ],
    "Source/GTT/Private/Vehicles/GTTOldCarPawn.cpp": [
        "Rattleback 82", "Rattleback82", "SetMassOverrideInKg", "DriveAcceleration = 2350.0f"
    ],
    "Source/GTT/Private/Vehicles/GTTFarmVanPawn.cpp": [
        "Mulebox 1200", "Mulebox1200", "SetMassOverrideInKg", "FuelCapacityLiters = 62.0f"
    ],
    ...
    "Source/GTT/Private/UI/GTTGameHUD.cpp": ["WANTED [", "CASH $", "FUEL %.0f%%", "F5 save", "GetClockText", "GARAGE %d/%d"],
    "Source/GTT/Private/World/GTTPrototypeWorld.cpp": [
        "4-SLOT GARAGE", "SpawnActor<AGTTOldCarPawn>", "SpawnActor<AGTTFarmVanPawn>", "RATTLEBACK 82", "MULEBOX 1200", "PRIVATE LAKE - NO FISHING"
    ],
    "Source/GTT/Private/Core/GTTGameMode.cpp": [
        "SaveGameToSlot", "LoadGameFromSlot", "SaveVersion = 2", "OwnedVehicles", "TryRegisterVehicle", "GarageCapacity", "GetOwnedVehicleCount", "Save->SaveVersion >= 2"
    ],
...
def main() -> int:
    ...
    print("[OK] GTT 0.0.6 multi-vehicle garage, save migration and vehicle roster hooks look structurally sane.")
    return 0
