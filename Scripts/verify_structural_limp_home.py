...
print(f'[OK] Persistent structural limp-home dynamics verified ({len(checks)} checks; runtime {minimum_alive}s); roadmap {done}/{total} = {percent:.1f}% with SVG-only progress.')
