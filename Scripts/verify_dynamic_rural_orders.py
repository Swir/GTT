...
print(f"[OK] GTT 0.1.6 dynamic rural orders, cross-day backlog and ROAD/CARGO supply consequences verified ({len(checks)} checks); roadmap {done}/{total} = {percent:.1f}% with SVG-only progress.")
