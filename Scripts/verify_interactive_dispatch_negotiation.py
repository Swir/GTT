...
print(f"[OK] GTT 0.1.7 interactive dispatchers, negotiated CARGO choices and persistence verified ({len(checks)} checks); roadmap {done}/{total} = {percent:.1f}% with SVG-only progress.")
