...
print(f"[OK] GTT 0.1.5 rural dispatchers, depot stock/demand and contract rotation verified ({len(checks)} checks); roadmap {done}/{total} = {percent:.1f}% with SVG-only progress.")
