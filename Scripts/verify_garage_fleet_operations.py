...
print(f"[OK] 0.0.97 garage fleet operations, Native authority recall and workshop quote UX verified ({len(checks)} checks); roadmap {done}/{total} = {percent:.1f}% with SVG-only progress.")
