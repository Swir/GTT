...
required = [
    (road_h + road_cpp, 'EGTTRoadDamageZone'), (road_h + road_cpp, 'FGTTRoadBodyDamageSnapshot'),
    (road_cpp, 'DetermineImpactZone'), (road_cpp, 'NATIVE_ROAD_DAMAGE_ZONE'), (road_cpp, 'NATIVE_ROAD_PANEL_DETACH'),
    (road_cpp, 'NATIVE_ROAD_DAMAGE_DYNAMICS'), (road_cpp, 'NATIVE_ROAD_WORKSHOP_RESTORE'), (road_cpp, 'CoolingStress'),
    (road_cpp, 'DamageThrottleLimit'), (road_cpp, 'DamageSteeringLimit'), (road_cpp, 'RearBodyRisk'), (road_cpp, 'GetBodyDamageRepairSurcharge'),
    (service_cpp, 'FindActiveNativeRoadVehicle'), (service_cpp, 'ApplyNativeWorkshopService'), (service_cpp, 'HasActiveNativeRoadTakeover'),
