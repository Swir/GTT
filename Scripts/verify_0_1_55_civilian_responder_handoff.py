...
require(
    ...
    "ResponderSpawnDistanceCm = 1900.0f",
)
require(
    save_h,
    "responder sidecar",
    "UGTTCivilianResponderSaveGame : public USaveGame",
    "SchemaVersion = 1",
    "IncidentId",
    "Phase",
    "PlayerGraceElapsed",
...
require(
    vehicle_cpp,
    "physical responder implementation",
...
require(
    dispatch_h,
    "0.1.54 authoritative dispatch surface",
    "GetActiveIncidentId()",
    "GetActiveIncidentSeverity()",
    "IsTrackedVehicle",
    "GetPresentationSnapshot",
)
require(
    dispatch_cpp,
    "0.1.54 dispatch authority regression",
...
require(
    sub_cpp,
    "responder subsystem implementation",
    'TEXT("GTT_CivilianResponder_01")',
    "GetSubsystem<UGTTCivilianIncidentDispatchSubsystem>()",
    "Dispatch->GetActiveIncidentId()",
    "Dispatch->GetActiveIncidentSeverity()",
    "Dispatch->GetPresentationSnapshot(nullptr)",
    "Dispatch->IsTrackedVehicle(Candidate)",
...
require(
    traffic_h,
    "traffic responder API",
    "IsRoadsideResponderSceneAuthority()",
    "SetRoadsideResponderSceneAuthority(bool bActive)",
    "CompleteRoadsideResponderRecovery()",
    "ResponderRecoveryFraction = 0.38f",
    "ResponderPostRecoveryLimpSeconds = 18.0f",
)

begin_assist = function_body(
    traffic_cpp,
    "bool AGTTTrafficCarPawn::BeginRoadsideAssistance(AActor* Helper)",
    ("void AGTTTrafficCarPawn::CancelRoadsideAssistance",),
)
require(
    begin_assist,
    "player-first/scene-authority guard",
    "bRoadsideResponderSceneAuthority",
    "County road service has scene authority",
    "return false;",
)
...
player_complete = function_body(
    traffic_cpp,
    "void AGTTTrafficCarPawn::CompleteRoadsideAssistance()",
    ("void AGTTTrafficCarPawn::SetRoadsideResponderSceneAuthority",),
)
require(
    player_complete,
    "existing player payout authority",
...
responder_complete = function_body(
    traffic_cpp,
    "bool AGTTTrafficCarPawn::CompleteRoadsideResponderRecovery()",
    ("void AGTTTrafficCarPawn::Tick(",),
)
require(
    responder_complete,
    "no-payout responder recovery",
    "bRoadsideResponderSceneAuthority",
    "RepairVehicle(MaxCondition * ResponderRecoveryFraction);",
    "ResponderPostRecoveryLimpSeconds",
...
require(
    traffic_cpp,
    "traffic lifecycle integration",
    "bRoadsideResponderSceneAuthority = false;",
    "bRoadsideResponderSceneAuthority || bYieldingForRangerStop",
    "County road service - recovery in progress",
)
