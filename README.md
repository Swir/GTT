...
Current development milestone: **0.1.57 — scene clearance + physical trailer dynamics**.
...
| 🌾 Legal rural work | Farm cargo, mowing, timber hauling, recovery and heavier trailer/logistics jobs tied to economy and vehicle condition. Farm Cargo locks the actual loaded vehicle to the contract so another vehicle cannot complete its handoff; the physical farm trailer now has bounded wheel suspension and a load/damage/stress-sensitive breakable hitch while authored final wheel/hitch assets remain gated. |
