...
| 7. Checkout economy | checkout waits until completion time; single debit equals URGENT locked quote; no duplicate debit; failed mutation would use existing rollback; successful service repairs condition/tires; successful service refuels through production repair path |
