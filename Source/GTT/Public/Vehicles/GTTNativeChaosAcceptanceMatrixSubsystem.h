...
private:
    ...
    bool EvaluateLiveMatrix(APawn* Pawn,FName VehicleId,bool bPawnReady,UChaosWheeledVehicleMovementComponent* Movement,USkeletalMeshComponent* Mesh,int32& OutValidWheels,int32& OutGroundContacts,int32& OutSuspensionSamples,float& OutMinSuspension,float& OutMaxSuspension,bool& bOutWheelConfig,bool& bOutPowertrainConfig,FString& OutWheelSummary,FString& OutPowertrainSummary) const;
