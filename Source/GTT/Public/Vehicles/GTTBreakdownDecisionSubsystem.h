...
struct GTT_API FGTTBreakdownAssessment
{
    ...
    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category="GTT|Vehicle|Breakdown") int32 EmergencyPatchEstimate = 0;
    ...
    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category="GTT|Vehicle|Breakdown") bool bEmergencyPatchPossible = false;
};
...
public:
    ...
    UFUNCTION(BlueprintPure, Category="GTT|Vehicle|Breakdown") int32 CalculateRoadsidePatchEstimate(const AGTTRoadVehicleNativePawn* Vehicle) const;
    UFUNCTION(BlueprintPure, Category="GTT|Vehicle|Breakdown") bool CanEmergencyPatch(const AGTTRoadVehicleNativePawn* Vehicle) const;
};
