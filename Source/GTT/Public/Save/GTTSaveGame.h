...
public:
    ...
    UPROPERTY(VisibleAnywhere, SaveGame, Category="GTT|Save|Unified")
    bool bUnifiedWorldStateInitialized = false;

    UPROPERTY(VisibleAnywhere, SaveGame, Category="GTT|Save|Unified")
    int32 UnifiedWorldStateRevision = 0;

    UPROPERTY(VisibleAnywhere, SaveGame, Category="GTT|Save|Unified|Combat")
    TArray<uint8> CombatWeaponTypes;

    UPROPERTY(VisibleAnywhere, SaveGame, Category="GTT|Save|Unified|Combat")
    uint8 CombatEquippedWeaponType = 0;

    UPROPERTY(VisibleAnywhere, SaveGame, Category="GTT|Save|Unified|Combat")
    int32 CombatShotgunAmmo = 0;

    UPROPERTY(VisibleAnywhere, SaveGame, Category="GTT|Save|Unified|Story")
    ...
    UPROPERTY(VisibleAnywhere, SaveGame, Category="GTT|Save|Unified|Story")
    int32 Arc4StartingFactionVictories = 0;

    UPROPERTY(VisibleAnywhere, SaveGame, Category="GTT|Save|Unified|Story")
    bool bArc4ContrabandPrepared = false;

    UPROPERTY(VisibleAnywhere, SaveGame, Category="GTT|Save|Unified|Factions")
    ...
    UPROPERTY(VisibleAnywhere, SaveGame, Category="GTT|Save|Unified|RuralEconomy")
