...
int32 AGTTGameMode::GetWildlifeAlertLevel() const
{
    if (WildlifeHeat >= 65.0f) return 3;
    if (WildlifeHeat >= 30.0f) return 2;
    return WildlifeHeat > KINDA_SMALL_NUMBER ? 1 : 0;
}
